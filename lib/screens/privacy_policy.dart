...
class _PrivacyPolicyState extends State<PrivacyPolicy> with WidgetsBindingObserver{
  bool _value = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Privacy Policy',style: TextStyle(color: bluecolor,fontSize: 27.sp),),
        centerTitle: true,
        elevation: 0,
